...
internal struct Random {
    ...
    internal static func generate(_ upperBound: Int) -> Int {
        #if os(Linux)
...
final internal class AES256CBC {
    ...
    internal class func encryptString(_ str: String, password: String) -> String? {
    ...
    internal class func encryptString(_ str: String, password: String, iv: String) -> String? {
        if !str.isEmpty {
            let iv = iv
            let key = password
    ...
    internal class func decryptString(_ str: String, password: String) -> String? {
        if !str.isEmpty {
    ...
    internal class func decryptString(_ str: String, password: String, iv: String) -> String? {
        if !str.isEmpty {
            let iv = iv
    ...
    internal class func generatePassword() -> String {
    ...
    internal class func randomText(_ length: Int, justLowerCase: Bool = false, whitespace: Bool = false) -> String {
        var chars = [UInt8]()
...
extension AESCipher {
    ...
    convenience internal init(key: String, iv: String) throws {
